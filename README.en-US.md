...
*Note: You can also use go module mode, configure in go.mod, such as: `github.com/ying32/govcl v2.0.3+incompatible`, and replace the version number with the latest version.*  
