...
func (r *TRadioGroup) BeginDrag(Immediate bool, Threshold int32) {
    RadioGroup_BeginDrag(r._instance(), Immediate , Threshold)
}
...
func (r *TRadioGroup) EndDrag(Drop bool) {
    RadioGroup_EndDrag(r._instance(), Drop)
}
